...
import com.google.samples.apps.nowinandroid.feature.interests.impl.navigation.InterestsDetailPlaceholderNavKey
...
@NavEdge(to = ForYouNavKey::class, label = "For you")
...
@NavEdge(to = InterestsDetailPlaceholderNavKey::class, label = "Select interest")
@Composable
fun InterestsScreen(
...
@DevicePreviews
@NavPreview(route = InterestsNavKey::class, primary = true)
@Composable
