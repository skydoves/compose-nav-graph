...
internal object Ocean {
    val deep = Color(0xFF03045E)
    val dark = Color(0xFF023E8A)
    val mid = Color(0xFF0077B6)
    val bright = Color(0xFF0096C7)
    val light = Color(0xFF00B4D8)
    val teal = Color(0xFF48CAE4)
    val foam = Color(0xFF90E0EF)
    val surface = Color(0xFFADE8F4)
    val mist = Color(0xFFCAF0F8)
    val divider = Color(0xFF004E8C)
}
