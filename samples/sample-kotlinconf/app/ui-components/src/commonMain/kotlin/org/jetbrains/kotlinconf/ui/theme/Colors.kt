...
val OceanBlueColors = Colors(
    isDark = true,

    mainBackground = Ocean.dark,
    primaryBackground = Ocean.mid,
    tileBackground = Ocean.bright,
    tooltipBackground = Ocean.deep,

    cardBackgroundPast = Color(0xFF012F6D),

    strokeFull = Ocean.mist,
    strokeAccent = Ocean.teal,
    strokeInputFocus = Ocean.foam,
    strokeHalf = Ocean.light,
    strokePale = Ocean.divider,

    accentText = Ocean.teal,
    longText = Ocean.surface,
    noteText = Ocean.foam,
    placeholderText = Ocean.teal,
    primaryText = white100,
    primaryTextInverted = Ocean.deep,
    primaryTextWhiteFixed = white100,
    secondaryText = Ocean.foam,

    purpleText = Ocean.teal,
    magentaText = Ocean.light,
    pinkText = Ocean.foam,
    orangeText = Ocean.mist,
