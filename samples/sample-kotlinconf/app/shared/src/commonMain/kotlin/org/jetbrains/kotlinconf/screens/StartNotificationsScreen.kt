...
@NavDestination(route = org.jetbrains.kotlinconf.navigation.StartNotificationsScreen::class)
@NavEdge(to = org.jetbrains.kotlinconf.navigation.ScheduleScreen::class, label = "Finish onboarding")
@Composable
...
@NavPreview(route = org.jetbrains.kotlinconf.navigation.StartNotificationsScreen::class, primary = true)
@Preview
@Composable
private fun StartNotificationsScreenNavPreview() {
    KotlinConfTheme {
        Column(
            modifier = Modifier
                .fillMaxSize()
