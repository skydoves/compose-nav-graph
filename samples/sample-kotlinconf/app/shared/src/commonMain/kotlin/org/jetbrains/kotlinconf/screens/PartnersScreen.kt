...
@NavDestination(route = org.jetbrains.kotlinconf.navigation.PartnersScreen::class)
@NavEdge(to = org.jetbrains.kotlinconf.navigation.PartnerDetailScreen::class, label = "Open partner")
@Composable
fun PartnersScreen(
    onBack: () -> Unit,
...
@NavPreview(route = org.jetbrains.kotlinconf.navigation.PartnersScreen::class, primary = true)
@Preview
@Composable
private fun PartnersScreenNavPreview() {
    KotlinConfTheme {
        Column(
            Modifier
                .fillMaxSize()
            ...
            MainHeaderTitleBar(title = stringResource(Res.string.partners_title))
            HorizontalDivider(thickness = 1.dp, color = KotlinConfTheme.colors.strokePale)
            ...
            Column(
                ...
                PartnerCard(name = "JetBrains", logoUrl = "", onClick = {})
                PartnerCard(name = "Google", logoUrl = "", onClick = {})
                PartnerCard(name = "Gradle", logoUrl = "", onClick = {})
            }
        }
    }
}
