...
@NavDestination(route = org.jetbrains.kotlinconf.navigation.AppPrivacyNoticePrompt::class)
...
@Composable
private fun PrivacyNoticePromptPreviewBody() {
    Column(
        horizontalAlignment = Alignment.CenterHorizontally,
...
@NavDestination(route = org.jetbrains.kotlinconf.navigation.StartPrivacyNoticeScreen::class)
@NavEdge(to = org.jetbrains.kotlinconf.navigation.StartNotificationsScreen::class, label = "Set up notifications")
@NavEdge(to = org.jetbrains.kotlinconf.navigation.ScheduleScreen::class, label = "Skip to schedule")
@NavEdge(to = org.jetbrains.kotlinconf.navigation.AppTermsOfUseScreen::class, label = "Terms of use")
@NavPreview(route = org.jetbrains.kotlinconf.navigation.StartPrivacyNoticeScreen::class, primary = true)
@Preview
@Composable
private fun StartPrivacyNoticeScreenNavPreview() {
    KotlinConfTheme {
        PrivacyNoticePromptPreviewBody()
    }
}

@NavPreview(route = org.jetbrains.kotlinconf.navigation.AppPrivacyNoticePrompt::class, primary = true)
@Preview
@Composable
private fun AppPrivacyNoticePromptNavPreview() {
    KotlinConfTheme {
        PrivacyNoticePromptPreviewBody()
    }
}
