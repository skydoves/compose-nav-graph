...
@NavDestination(route = org.jetbrains.kotlinconf.navigation.SpeakerDetailScreen::class)
@NavEdge(to = org.jetbrains.kotlinconf.navigation.SessionScreen::class, label = "Open session")
@Composable
...
@NavPreview(route = org.jetbrains.kotlinconf.navigation.SpeakerDetailScreen::class, primary = true)
@Preview
@Composable
private fun SpeakerDetailScreenNavPreview() {
    KotlinConfTheme {
        val speaker = Speaker(
            id = SpeakerId("1"),
            name = "Roman Elizarov",
            position = "Kotlin Project Lead, JetBrains",
            description = "Roman is the project lead for the Kotlin programming language. " +
                "He is passionate about concurrency, coroutines, and building tools that " +
        ...
        Column(
            ...
            Column(
                ...
                TalkCard(
                    ...
                    bookmarked = false,
                    onBookmark = {},
                    tags = setOf("Coroutines", "Advanced"),
                    tagHighlights = emptyList(),
